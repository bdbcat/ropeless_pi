 ...
 */
class PI_OCP_DataStreamInput_Thread: public wxThread
{
public:

    PI_OCP_DataStreamInput_Thread(ropeless_pi *Launcher,
    ...
    ~PI_OCP_DataStreamInput_Thread(void);
    void *Entry();
