...
PI_OCPN_DataStreamEvent::PI_OCPN_DataStreamEvent(wxEventType commandType, int id)
      :wxEvent(id, commandType)
{
    //m_pDataStream = NULL;
}

PI_OCPN_DataStreamEvent::~PI_OCPN_DataStreamEvent()
{
}
...
//----------------------------------------------------------------------------------
wxString PI_OCPN_DataStreamEvent::ProcessNMEA4Tags()
{
...
wxEvent* PI_OCPN_DataStreamEvent::Clone() const
{
    PI_OCPN_DataStreamEvent *newevent=new PI_OCPN_DataStreamEvent(*this);
