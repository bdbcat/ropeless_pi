...
IMPLEMENT_DYNAMIC( LORAN_TTIME_DIFFERENCE, CObject )

LORAN_TTIME_DIFFERENCE::LORAN_TTIME_DIFFERENCE()
{
   Empty();
}
...
void LORAN_TTIME_DIFFERENCE::Empty( void )
{
   ASSERT_VALID( this );
   Microseconds = 0.0;
...
void LORAN_TTIME_DIFFERENCE::Parse( int first_field_number, const SENTENCE& sentence )
{
   ASSERT_VALID( this );
...
void LORAN_TTIME_DIFFERENCE::Write( SENTENCE& sentence )
{
   ASSERT_VALID( this );
...
const LORAN_TTIME_DIFFERENCE& LORAN_TTIME_DIFFERENCE::operator = ( const LORAN_TTIME_DIFFERENCE& source )
{
   ASSERT_VALID( this );
