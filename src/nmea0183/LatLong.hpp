...
class LATITUDE
{
   ...
   public:
      ...
      */
      ...
      virtual void Parse( int PositionFieldNumber, const SENTENCE& LineToParse );
      virtual void Parse( double value );
...
class LATLONG
{
   ...
   public:
      ...
      */
      ...
      virtual void Empty( void );
      virtual bool Parse( int LatitudePostionFieldNumber, int NorthingFieldNumber, int LongitudePositionFieldNumber,
                          int  EastingFieldNumber, const SENTENCE& LineToParse );
      virtual bool Parse( int LatitudePositionFieldNumber, int LongitudePositionFieldNumber, const SENTENCE& LineToParse );
      virtual void Write( SENTENCE& sentence );
