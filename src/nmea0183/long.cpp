...
void LONGITUDE::Parse( int position_field_number, const SENTENCE& sentence )
{
   Set( sentence.Double( position_field_number ) );
}

void LONGITUDE::Parse( double value )
{
   Easting = East;
   if(value < 0)
     Easting = West;
...
void LONGITUDE::Set( double position )
{

   Longitude = abs(position);
