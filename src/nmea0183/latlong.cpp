...
bool LATLONG::Parse( int LatitudePositionFieldNumber, int LongitudePositionFieldNumber, const SENTENCE& LineToParse )
{

   Latitude.Parse(  LatitudePositionFieldNumber, LineToParse );
   Longitude.Parse( LongitudePositionFieldNumber, LineToParse );
